...
Verifier SHA-256:     a45ef7f788ca87eecdbb29b0d4151e54b9ac34a8e22fcee784b6369f00bdd36f
...
```bash
# Option A — silent terminal prompt (no password in shell history; zsh compatible)
source .env.dev
read -rs "PGPASSWORD?Dev DB password: "
printf '\n'
export PGPASSWORD
...
shasum -a 256 supabase/verification/prod_schema_verify.sql
# Expected: a45ef7f788ca87eecdbb29b0d4151e54b9ac34a8e22fcee784b6369f00bdd36f
```
...
- 27 expected functions present; `forkensics_executor` ownership confirmed
...
- [ ] Credential scan clean (all four grep patterns return no output)
