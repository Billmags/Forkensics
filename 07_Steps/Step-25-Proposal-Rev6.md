# Step 25 Proposal — Rev 6 — V2 Migration: Upload Session Infrastructure
...
**Changes from Rev 5 (addressing 3 Codex blockers):**
...
Assert (control):
             Session C result set DOES contain session_id = S with prior_status = 'sanitized'.
             Row S now has status = 'failed'.
             This confirms the first exclusion was caused by the lock, not ineligibility.
